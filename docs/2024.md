...
* Jenkins in Google Summer of Code 2024
    * Approved for [5 projects](https://www.jenkins.io/blog/2024/05/01/google-summer-of-code-congrats-and-welcome/)
        * [Manage GitHub permissions as code](https://www.jenkins.io/projects/gsoc/2024/project-ideas/automating-rpu-for-jenkinsci-organization/) - Danyang Zhao / Alex Brandes
        * [OpenRewrite for plugin modernization](https://www.jenkins.io/projects/gsoc/2024/project-ideas/using-openrewrite-recipes-for-plugin-modernization-or-automation-plugin-build-metadata-updates/) - Sridhar Sivakumar / Valentin Delaye
        * [UI for Jenkins infrastructure statistics](https://www.jenkins.io/projects/gsoc/2024/project-ideas/implementing-ui-for-jenkins-infra-statistics/) - Shlomo Dahan / Kris Stern
        * [Jenkins knowledge in an LLM](https://www.jenkins.io/projects/gsoc/2024/project-ideas/enhancing-an-existing-llm-model-with-domain-specific-jenkins-knowledge/) - Nour Almulhem / Kris Stern
        * [Repository Permissions Updater automation](https://www.jenkins.io/projects/gsoc/2024/project-ideas/automating-rpu-for-jenkinsci-organization/) - Phillipp Glanz / Alex Brandes
...
* Propose to cancel next governance meeting May 27, 2024
    ...
    * Approved 5 of 5
        ...
        * Meet more frequently if board approval of an urgent topic needs discussion
            * 5 of 5 approved
* Require Java 17 in Jenkins weekly - [mailing list thread](https://groups.google.com/g/jenkinsci-dev/c/gsXAqOQQEPc/m/4fn4Un1iAwAJ)
